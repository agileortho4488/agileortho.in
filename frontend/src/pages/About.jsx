      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-emerald-600 text-xs font-bold uppercase tracking-[0.2em] mb-2">Our Principal</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="bg-slate-50 border border-slate-200 rounded-sm p-5 text-center">
                  <Icon size={24} className="mx-auto text-emerald-600 mb-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={title} className="bg-white border border-slate-200 rounded-sm p-6">
                <div className="w-10 h-10 rounded-sm bg-emerald-50 flex items-center justify-center mb-3">
                  <Icon size={20} className="text-emerald-600" />
                </div>
                <h3 className="font-bold text-slate-900 mb-1" style={{ fontFamily: "Chivo" }}>{title}</h3>
      ...
      <section className="bg-emerald-600 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Link to="/contact" className="px-6 py-3 bg-white text-emerald-700 font-semibold rounded-sm hover:bg-emerald-50 transition-colors">
              Request Quote
            </Link>
            <Link to="/products" className="px-6 py-3 border border-emerald-300 text-white font-semibold rounded-sm hover:bg-emerald-700 transition-colors">
              Browse Products
            </Link>
          </div>
        </div>
