      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 relative z-10">
        <div className="grid gap-10 sm:gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs font-bold text-[#D4AF37] tracking-[0.2em] uppercase">
              {COMPANY.tagline}
            </p>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3">
              <li><Link href="/catalog" className="text-sm text-white/55 hover:text-white transition-colors">Product Catalog</Link></li>
              <li><Link href="/about" className="text-sm text-white/55 hover:text-white transition-colors">About Agile Ortho</Link></li>
              <li><Link href="/contact" className="text-sm text-white/55 hover:text-white transition-colors">Contact &amp; Quotes</Link></li>
              <li><Link href="/chat" className="text-sm text-white/55 hover:text-white transition-colors">AI Assistant</Link></li>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3">
              <li><Link href="/districts/hyderabad" className="text-sm text-white/55 hover:text-white transition-colors">Hyderabad</Link></li>
              <li><Link href="/districts/warangal" className="text-sm text-white/55 hover:text-white transition-colors">Warangal</Link></li>
              <li><Link href="/districts/karimnagar" className="text-sm text-white/55 hover:text-white transition-colors">Karimnagar</Link></li>
              <li><Link href="/districts/nizamabad" className="text-sm text-white/55 hover:text-white transition-colors">Nizamabad</Link></li>
              <li><Link href="/districts/khammam" className="text-sm text-white/55 hover:text-white transition-colors">Khammam</Link></li>
              <li><Link href="/districts" className="text-sm text-[#2DD4BF] hover:text-[#5EEAD4] transition-colors font-medium">All 33 Districts</Link></li>
            </ul>
          </div>

          <div className="text-center sm:text-left">
            <div className="text-xs font-bold text-[#D4AF37] tracking-[0.15em] uppercase mb-5">Compliance</div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-6 sm:flex-row">
          ...
          <div className="flex items-center gap-4 text-xs text-white/35">
            ...
            <span className="h-1 w-1 rounded-full bg-white/10" />
            <a
              href="https://telehealth-analytics-1.preview.emergentagent.com/admin/login"
              target="_blank"
              rel="noreferrer"
